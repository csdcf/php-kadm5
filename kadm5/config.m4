...
if test "$PHP_KADM5" != "no"; then
  ...
  PHP_ADD_LIBRARY_WITH_PATH(kadm5clnt, $KADM5_DIR/lib, KADM5_SHARED_LIBADD)
  dnl PHP_ADD_LIBRARY_WITH_PATH(kdb5, $KADM5_DIR/lib, KADM5_SHARED_LIBADD)
  PHP_ADD_LIBRARY_WITH_PATH(gssrpc, $KADM5_DIR/lib, KADM5_SHARED_LIBADD)
  PHP_ADD_LIBRARY_WITH_PATH(krb5, $KADM5_DIR/lib, KADM5_SHARED_LIBADD)
  PHP_ADD_LIBRARY_WITH_PATH(k5crypto, $KADM5_DIR/lib, KADM5_SHARED_LIBADD)
